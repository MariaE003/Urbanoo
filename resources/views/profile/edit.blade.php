    ...
    <div class="grid gap-6 xl:grid-cols-[360px_minmax(0,1fr)]">
            ...
            <div class="rounded-[28px] border border-gray-100 bg-gradient-to-br from-slate-50 to-white p-6 shadow-sm">
                <div class="space-y-5">
                    ...
                    <div class="flex flex-col items-center text-center">
                        ...
                        <h2 class="mt-4 text-2xl font-bold text-black">{{ $user->name }}</h2>
        ...
        <div class="space-y-6">
            <section class="rounded-[28px] border border-gray-100 bg-white p-6 shadow-sm sm:p-8">
                ...
                <form id="formVerificationEmail" method="POST" action="{{ route('verification.send') }}">
                    @csrf
                </form>
            ...
            <section class="rounded-[28px] border border-red-100 bg-white p-6 shadow-sm sm:p-8">
                ...
                <form id="formSuppressionCompte" method="POST" action="{{ route('profile.destroy') }}" class="space-y-5">
                    @csrf
                    @method('DELETE')
...
<script>
    function activerPhotoProfilLocale() {
        ...
        let lettreInitiale = @json(strtoupper(substr($user->name, 0, 1)));
