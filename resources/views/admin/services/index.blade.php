...
<div class="mx-auto max-w-[1280px] space-y-6">
    <div class="flex items-center justify-between gap-4">
        ...
        <a href="{{ route('home') }}" class="inline-flex h-11 items-center justify-center rounded-2xl border border-gray-300 px-5 text-sm font-medium text-gray-700 transition hover:bg-gray-50">
            Retour à la carte
        </a>
    </div>
