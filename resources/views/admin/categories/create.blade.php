        ...
        <div class="rounded-[28px] border border-gray-100 bg-white p-6 shadow-sm sm:p-8">
            <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}" class="h-12 w-full rounded-2xl border border-gray-300 px-4 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Ex: Voirie">
                    @error('name')
