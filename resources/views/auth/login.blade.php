                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <div class="flex flex-col gap-3 pt-1 md:flex-row md:items-center md:justify-between">
                        ...
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-sm text-gray-600 transition hover:text-blue-600">
                                Mot de passe oublié ?
                            </a>
                        @endif
                    </div>
                    ...
                    <div class="text-center">
                        <a href="{{ route('register') }}" class="text-sm text-gray-600 hover:text-blue-600">
