    ...
    <header class="border-b border-gray-200 bg-white/95 backdrop-blur">
        <div class="mx-auto flex max-w-[1400px] items-center gap-4 px-4 py-4 sm:px-6">
            ...
            <div class="ml-auto hidden items-center gap-3 lg:flex">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="rounded-2xl border border-gray-200 px-5 py-2.5 text-sm font-medium text-gray-700 transition hover:bg-gray-50 hover:text-blue-600">
                        Connexion
                    </a>
                    <a href="<?php echo e(route('register')); ?>" class="rounded-2xl bg-blue-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-blue-700">
                        Créer un compte
                    </a>
                <?php endif; ?>
            </div>
        ...
        <div id="menuMobile" class="hidden border-t border-gray-100 bg-white lg:hidden">
            <div class="mx-auto flex max-w-[1400px] flex-col gap-2 px-4 py-4 sm:px-6">
                ...
                <div class="mt-2 flex flex-col gap-2 border-t border-gray-100 pt-4">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="rounded-2xl border border-gray-200 px-4 py-3 text-center text-sm font-medium text-gray-700 transition hover:bg-gray-50 hover:text-blue-600">
                            Connexion
                        </a>

                        <a href="<?php echo e(route('register')); ?>" class="rounded-2xl bg-blue-600 px-4 py-3 text-center text-sm font-medium text-white transition hover:bg-blue-700">
                            Créer un compte
                        </a>
                    <?php endif; ?>
                </div>
...
</html><?php /**PATH C:\Apache24\htdocs\Urbanoo\resources\views/partials/header.blade.php ENDPATH**/ ?>